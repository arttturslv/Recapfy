            ...
            <div className="space-y-2 px-6 ">
                ...
                <div className="h-max flex-grow space-y-2 text-sm font-extralight">
                    ...
                    <p>
                        ...
                        mais populares, com base nos 50 artistas mais ouvidos e
                        seus principais estilos. Ele mostra os gêneros que mais
                        marcaram suas playlists ao longo do tempo.
                    </p>

                    <p>
                        Com essa análise, você pode perceber se você está mais
                        para o{' '}
                        <strong>
                            {allGenres[0]
                                ? allGenres[0][0]
                        ...
                        , que aparece de surpresa e te faz questionar se você
                        tem uma veia mais eclética do que imaginava!
                    </p>

                    <p>
                        Além disso, ao lado, você verá uma lista dos outros
                        gêneros presentes na sua biblioteca musical, organizados
                        pela quantidade de vezes que seus artistas mais ouvidos
                        estão associados a eles. Isso mostra a diversidade da
                        sua coleção musical e a variedade dos seus gostos.
                    </p>
